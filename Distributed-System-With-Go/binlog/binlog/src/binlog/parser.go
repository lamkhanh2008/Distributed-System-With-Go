...
// func (m *BinlogParser) getBinlogIdByName(e *canal.RowsEvent, columnName string) int {
...
// type Execute_db interface {
// 	Execute_sourcedb_to_desdb(dbSource *sql.DB) error
// }

// type handleBiglog struct {
// 	dbSource *sql.DB
// }

// func (h *handleBiglog) Execute_sourcedb_to_desdb() error
// // func (h *handleBiglog) Execute_sourcedb_to_desdb(dbSource *sql.DB) error {
