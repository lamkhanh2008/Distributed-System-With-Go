...
func NewTCPConnection(name string, conn net.Conn, sendChanSize int, codec mtproto.Codec, cb closeCallback) *TCPConnection {
...
// Codec func
func (c *TCPConnection) Codec() mtproto.Codec {
	return c.codec
}
